...
Config: config\keybridge.json  ->  {"bindings": [{"vk": 145, "mode": "hold", "send": ["ctrl","alt","f9"], "name": "wispr push-to-talk"}, ...]}
...
DEFAULT = {"bindings": [
    {"name": "wispr push-to-talk", "vk": 0x91, "mode": "hold", "send": ["ctrl", "alt", "f9"]},   # Scroll Lock
